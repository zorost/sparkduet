...
check("ctl switch accepts next", "[depth|fleet|next|split]" in ctl)
...
check("qwen parsers", "--tool-call-parser hermes" in compose and "--reasoning-parser qwen3" in compose)
